<template>
  <div class="terms-block">
    <h1 class="va-h1">Terms and Conditions</h1>
    ...
    <div class="terms-text-block">
      <h3 class="va-h3">Interpretation and Definitions</h3>
      <h3 class="va-h3">Interpretation</h3>
      <p>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to vegovoyce.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to vegovoyce, accessible from
            <a
              href="https://www.vegovoyce.com"
              rel="external nofollow noopener"
              target="_blank"
              >https://www.vegovoyce.com</a
            >
          </p>
        </li>
        <li>
    ...
    <div class="terms-text-block">
      <h3 class="va-h3">Acknowledgment</h3>
      <p>
    ...
    <div class="terms-text-block">
      <h3 class="va-h3">Links to Other Websites</h3>
      <p>
    ...
    <div class="terms-text-block">
      <h3 class="va-h3">Limitation of Liability</h3>
      <p>
    ...
    <div class="terms-text-block">
      <h3 class="va-h3">Governing Law</h3>
      <p>
    ...
    <div class="terms-text-block">
      <h3 class="va-h3">Disputes Resolution</h3>
      <p>
    ...
    <div class="terms-text-block">
      <h3 class="va-h3">For European Union (EU) Users</h3>
      <p>
    ...
    <div class="terms-text-block">
      <h3 class="va-h3">United States Legal Compliance</h3>
      <p>
    ...
    <div class="terms-text-block">
      <h3 class="va-h3">Severability and Waiver</h3>
      <h3 class="va-h3">Severability</h3>
      <p>
    ...
    <div class="terms-text-block">
      <h3 class="va-h3">Translation Interpretation</h3>
      <p>
    ...
    <div class="terms-text-block">
      <h3 class="va-h3">Changes to These Terms and Conditions</h3>
      <p>
      ...
      <ul>
        <li>
          ...
          <a
            ...
            class="__cf_email__"
            data-cfemail="a6d5d3d6d6c9d4d2e6d0c3c1c9d0c9dfc5c388c5c9cb"
            >[email&#160;protected]</a
          >
        </li>
      </ul>
